...
class Program
{
    ...
    {
        StringEnumerator stringEnumerator= new StringEnumerator("alisoltandaneshgahast");
        foreach(String str in stringEnumerator )
        {
            Console.WriteLine(str);
        }
        byteenumerable byti= new byteenumerable("ali");
        foreach(byte str in byti )
        {
            Console.WriteLine(str);
        }
    }
